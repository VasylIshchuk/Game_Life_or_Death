...
class Creature(GameEntity):
    ...
    def __init__(self, title):
        ...
        self.health_points = int(self._get_attribute("health_points"))
    ...
    def _clamp_chance(self, efficiency_chance):
        if efficiency_chance > 0.9: return 0.9
        elif efficiency_chance < 0.1: return 0.1
        else: return efficiency_chance
